...
const Main = ({ showPublicLinkContent, setShowPublicLinkContent }) => {
  ...
  return (
    <>
      {!showPublicLinkContent ? (
                ...
                <div className="search-box-input-container">
                  ...
                  <div>
                    ...
                    <div className="tooltip-container">
                      ...
                      />
                      <span className="tooltip-text">Use Microphone</span>
                    </div>
        ...
        <Plink setShowPublicLinkContent={setShowPublicLinkContent} />
      )}
    </>
  );
};
